...
while true; do
    ...
    case $option in
        ...
        5)
            ...
            "Shota" "18+" "Mature" "Pet Play" "Fisting" "Threesome" "Yuri-on-Yuri" "Tentacles" "Multiple-partners" "Whipping" "Bestiality" "Storyline" "Bondage" "Spanking" "Groping" "Massage" "Pee" 
...
sleep 10
        ...
        9)
            ...
            git pull https://github.com/4b1ss4l/nhscript.git
            ;;
        *)
